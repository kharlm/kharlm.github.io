$(document).ready(function() {
  ...
  window.facetracker = {
    ...
    getEyesRect: function(position) {
      ...
      differenceunits = position[27][1] - position[32][1];
      measurement = "Left Eye : " + position[27][1] + "<br>Right Eye : " + position[32][1] + "<br>Difference Units : " + differenceunits + "<br>Midpoint : " + position[33][1];
