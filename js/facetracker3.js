$(document).ready(function() {
  ...
  window.facetracker = {
    ...
    getEyesRect: function(position) {
      ...
      differenceunits = position[27][0] - position[32][0];
      measurement = "Left Eye : " + position[27][0] + " x " + position[27][0] + "<br>Right Eye : " + position[32][0] + " x " + position[32][1] + "<br>Difference Units : " + differenceunits + "<br>Midpoint : " + position[33][1];
      var myDiv = document.getElementById("measurementdata");
      myDiv.innerHTML = measurement;
